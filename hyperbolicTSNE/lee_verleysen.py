"""
Implementation of the paper "Scale-independent quality criteria for dimensionality reduction." by Lee and Verleysen,
2010. Taken from https://github.com/facebookresearch/PoincareMaps/blob/main/embedding_quality_score.py, and modified to
fit this framework.
"""
import numpy as np
import pandas as pd
